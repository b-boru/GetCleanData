...
featureNames <- read.table("features.txt", quote="", colClasses=c("numeric", "character"), comment.char="");
...
testFeatures <- read.table("test/X_test.txt", quote="", colClasses="numeric", comment.char="");
...
testFeatures$activity <- read.table("test/y_test.txt", quote="", colClasses="numeric", comment.char="")[[1]];
...
testFeatures$subject <- read.table("test/subject_test.txt", quote="", colClasses="numeric", comment.char="")[[1]];

# also load the training set, which uses the same format
trainFeatures <- read.table("train/X_train.txt", quote="", colClasses="numeric", comment.char="");
trainFeatures <- trainFeatures[,validColumns];
names(trainFeatures) <- featureNames;
trainFeatures$activity <- read.table("train/y_train.txt", quote="", colClasses="numeric", comment.char="")[[1]];
trainFeatures$subject <- read.table("train/subject_train.txt", quote="", colClasses="numeric", comment.char="")[[1]];
...
activities <- read.table("activity_labels.txt", quote="", colClasses=c("numeric", "character"), comment.char="");
